...
Client React pour une plateforme e-commerce, développé en solo. Consomme l'API REST Laravel du dépôt ShopEase API.
...
npm start
​
Nécessite l'API backend (ShopEase API) lancée en parallèle.
